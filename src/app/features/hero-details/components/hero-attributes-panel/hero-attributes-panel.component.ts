...
@Component({
  selector: 'app-hero-attributes-panel',
  templateUrl: './hero-attributes-panel.component.html',
  styleUrls: ['./hero-attributes-panel.component.css']
})
export class HeroAttributesPanelComponent implements OnInit {
  @Input() hero?: Hero;
